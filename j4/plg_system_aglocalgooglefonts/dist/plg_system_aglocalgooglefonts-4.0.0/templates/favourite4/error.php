...
if ($this->error->getCode() == '404') {
	$redirect = true;
	if ((isset($_GET['view']) && isset($_GET['id']) && $_GET['view'] == 'article' && $_GET['id'] == $templateparams->get('error_page_article_id')) || strstr($current_url, '.css') !== false || strstr($current_url, '.js') !== false) {
		$redirect = false;
	}
	if ($redirect) {
		$db = JFactory::getDBO();
