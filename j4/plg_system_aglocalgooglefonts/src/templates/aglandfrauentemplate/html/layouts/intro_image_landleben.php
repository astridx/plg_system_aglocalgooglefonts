...
<?php if (isset($images->image_intro) && !empty($images->image_intro)) : ?>
	...
	src="<?php echo htmlspecialchars($images->image_intro); ?>" alt="<?php echo htmlspecialchars($images->image_intro_alt); ?>" class="img-fluid intro_image_landleben" itemprop="thumbnailUrl"/>
